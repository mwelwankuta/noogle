question_words = {
    ...
    "what", "whose", "whom", "who", "whose", "which", "where", "when", "how", "why"
}

joining_words = [
    "and", "or", "but", "because", "so", "although", "though", "while", "if", "when",
    "as", "since", "before", "after", "until", "once", "where", "how", "what", "that",
    "who", "which", "whether", "but also", "either", "neither",
