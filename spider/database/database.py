...
conn.execute(
    "create table if not exists meta (id integer primary key autoincrement not null, `url` varchar(255) not null, title varchar(255) not null, description varchar(255) not null, visits integer default 0 not null);"
)
conn.execute(
